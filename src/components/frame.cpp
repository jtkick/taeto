...
void Frame::set_chars(std::vector<std::string> chars)
{
...
void Frame::set_foreground_colors(std::vector<std::vector<Color>> color_vector)
{
...
// Set just the colors of all pixels in frame
void Frame::set_background_colors(std::vector<std::vector<Color>> color_vector)
{
    for (int i = 0; i < color_vector.size(); i++)
...
void Frame::set_bolds(std::vector<std::vector<bool>>)
{
    throw "Method not implemented yet.";
}

// Set just the normal vector parameter of all pixels in frame
void Frame::set_normals(std::vector<std::vector<Vector>> normals) // Ah yes, the vector<vector<Vector>>.
{
