...
bool Sprite::collides_with(std::shared_ptr<Sprite> sprite_ptr)
{
...
std::shared_ptr<Frame> Sprite::get_current_frame()
{

}

void Sprite::handle_collision(std::shared_ptr<Sprite> sprite_ptr)
{
